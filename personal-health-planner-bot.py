...
def main():
    ...
    st.markdown(
        "Welcome to Personal Health Planner Bot — an innovative Streamlit application that leverages your personal health metrics to deliver customized nutrition and exercise plans designed to help you achieve your wellness objectives.", unsafe_allow_html=True
    )
        ...
        if not hasattr(st.session_state, "openai_api_key"): 
            ...
            with st.spinner("Creating your customized Health Plan ..."):
                try:
                    ...
                    # Store the plans in session state.
                    st.session_state.dietary_plan = dietary_plan

                    # Display the dietary plan.
            ...
            # Add a disclaimer about seeking a second opinion from a certified expert.
            st.markdown("""
            **Disclaimer:** The health and fitness plans provided by this application are generated by an AI model and are intended for informational purposes only. For a comprehensive evaluation and personalized advice, please consult a certified health or fitness expert.
            ...
            # Combine dietary and fitness recommendations into a single text block.
            ...
            # Provide a download button for the combined recommendations.
            st.download_button(
